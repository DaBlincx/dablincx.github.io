...
(function() {
	...
	l(function() {
					...
					if (d && (/youtu\.?be/g.test(d[3]) || /vimeo/g.test(d[3])))
						if (d && /youtu\.?be/g.test(d[3])) {
							...
							h.onload = function() {
								...
								var x = h.naturalHeight,
									e = h.naturalWidth,
									f = h.naturalHeight / h.naturalWidth,
									D = b.parentNode.clientHeight,
							...
							if (d && /vimeo/g.test(d[3])) {
								var n =
									new XMLHttpRequest;
								n.open("GET", "https://vimeo.com/api/v2/video/" + d[6] + ".json", !0);
		...
		w() && navigator.userAgent.match(/Chrome/i) ? function(a, b) {
			...
			window.smartresize(function() {
				...
				0 > d.indexOf(a) && (a = d[window.innerWidth >
					a ? 1 : 0]);
		...
		if (u) e(document).on("add.cards changeParameter.cards", function(d) {
		...
		if (u) e(document).on("add.cards delete.cards", function(a) {
			k && clearTimeout(k);
	...
	if (!m) {
		...
		if (u && e.fn.socialLikes) e(document).on("add.cards",
			function(a) {
		...
		l(function() {
			if (!w() && document.querySelectorAll("input[name=animation]").length) {
				var a = function() {
						...
						c.forEach(function(c) {
							var h = c.offsetHeight,
								k = d(c);
							(k + h >= a && k - 50 <= g || b(c)) && c.classList.contains("hidden") && (c.classList.remove("hidden"), c.classList.add("animate__fadeInUp"), c.classList.add("animate__delay-1s"), c.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
				...
				var c = Array.from(document.querySelectorAll("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info"));
	...
	document.querySelectorAll("nav.navbar").length && (v = c(document.querySelector("nav.navbar")), document.querySelector(".mbr-after-navbar.mbr-fullscreen") && (document.querySelector(".mbr-after-navbar.mbr-fullscreen").style.paddingTop = v + "px"));
	if (!m && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./))) e(document).on("add.cards",
		function(a) {
			var b = a.target;
			...
			var a = function(a) {
				...
				b = function(b) {
					...
					f.addEventListener("click", function() {
						-1 !== c.indexOf("youtu") && d.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"); - 1 !== c.indexOf("vimeo") && g.pause();
	...
	if (!m) {
		...
		var z = document.querySelectorAll(".dropdown-menu.show");
	...
	m ||
		("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach(function(a) {
				a.getAttribute("data-isinit") || (A(a), F(a))
			...
			"undefined" === typeof window.initTestimonialsPlugin && 0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function(a) {
				...
				a.addEventListener("click", function() {
					...
					!d.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ?
						(c.classList.remove("mbri-arrow-up"), c.classList.add("mbri-arrow-down")) : (c.classList.remove("mbri-arrow-down"), c.classList.add("mbri-arrow-up")), -1 != b.indexOf("accordion") && (b = a.closest(".accordionStyles"), Array.from(b.children).filter(function(a) {
...
! function() {
	...
	if (!document.getElementById("top-1")) {
		...
		a.id = "top-1";
		a.style = "display: none";
		a.innerHTML = '<a href="https://mobirise.in">Mobirise Free Web Creator</a> Mobirise v5.5.8';
